...
disclaimer: >-
  ...
  pas suivre à la lettre les principes de Clean Architecture ou d'Architecture
  Hexagonale. J'utilise des outils fournis par le framework (conteneur IoC,
  gestionnaires d'événements) pour faciliter la communication entre couches, ce
  qui constitue un compromis pragmatique plutôt qu'un cloisonnement hermétique.
  L'objectif est de partager des pistes concrètes, pas d'imposer un dogme
  architectural.
summary: >-
...
references:
  ...
  - https://grafikart.fr/blog/je-deteste-plus-tailwindcss
  - https://romainlanz.com/articles/l-ia-est-un-outil-pas-un-pilote
thumbnail: /l-implementation-d-une-fonctionnalite-agnostique/thumbnail.png
pubDate: 2026-02-10
author: elysee
taxonomies:
