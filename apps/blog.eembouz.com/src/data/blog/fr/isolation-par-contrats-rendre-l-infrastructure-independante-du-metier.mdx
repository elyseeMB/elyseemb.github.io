...
disclaimer: >-
  ...
  architectural.
summary: >-
  Découplez votre domaine métier de l'infrastructure via des interfaces et
  l'injection de dépendances. Cette architecture en couches facilite l'évolution
  technique et le passage à l'échelle.
status: public
references:
