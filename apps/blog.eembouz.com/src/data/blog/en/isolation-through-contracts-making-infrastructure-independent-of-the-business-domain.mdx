...
summary: >-
  Decouple infrastructure from business logic using interfaces and dependency
  injection. This layered isolation ensures long-term scalability and technical
  flexibility.
status: public
references:
...
_example of a search interface_
