---
title: "Qu'est ce que les design Pattern"
author: emmanuelito
...
<p class="blog-single__paragraph">
  `/store/singleton.ts` **Singleton Pattern**
</p>
<br />
...
<p class="blog-single__paragraph">
  `factory.ts` — **Factory Pattern pour les clés**
</p>
<br />
...
<p class="blog-single__paragraph">`hooks/account.ts` — **Facade Pattern**</p>
